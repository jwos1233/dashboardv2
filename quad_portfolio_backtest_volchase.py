"""
Macro Quadrant Portfolio Backtest - VOLATILITY CHASING VERSION
Allocates to top 2 quadrants based on momentum scoring
Assets within each quad are weighted DIRECTLY by volatility (higher vol = higher weight)
Aggressive approach: "Volatility = Opportunity"
"""
...
class QuadrantPortfolioBacktest:
    """Backtest portfolio allocation based on quadrant momentum with VOLATILITY CHASING"""
    ...
    def __init__(self, start_date, end_date, initial_capital=10000, momentum_days=50, ema_period=50, vol_lookback=60):
        ...
        self.vol_lookback = vol_lookback  # Volatility lookback period
    ...
    def calculate_target_weights(self, top_quads):
        """Calculate target portfolio weights with DIRECT VOLATILITY WEIGHTING and EMA filter"""
        ...
        for date in top_quads.index:
            ...
            for quad, quad_weight in [(top1, 1.0), (top2, 1.0)]:
                ...
                # This is the opposite of risk parity - we're chasing volatility
    ...
    def run_backtest(self):
        ...
        print("=" * 70)
        print("QUADRANT PORTFOLIO BACKTEST - VOLATILITY CHASING")
        print("=" * 70)
...
if __name__ == "__main__":
    """
    PRODUCTION CONFIGURATION - VOLATILITY CHASING VERSION
    Aggressive approach: allocate MORE to high-volatility assets
    """
    # Strategy parameters
    ...
    VOL_LOOKBACK = 21        # 21-day volatility lookback for volatility chasing
    ...
    print(f"Volatility Lookback: {VOL_LOOKBACK} days (CHASING Volatility)")
